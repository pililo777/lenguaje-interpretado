...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_sin_graficos.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_sin_graficos ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/graficos.o: graficos.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graficos.o graficos.c
