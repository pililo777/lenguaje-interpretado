    ...
    with open(file_path, 'r') as file:
        ...
        for line in lines:
            if line.startswith("//#"):  # Usamos '#' para denotar un prompt
                ...
                completion += line + "\n"
                in_prompt = False
        # Eliminar el comentario de cabecera del prompt, strip para eliminar espacios en blanco
        prompt = prompt.replace("//#", "").strip()
        return {"messages" : [{"role":"system", "content":"eres un programador experto"}, {"role":"user", "content": prompt.strip()}, {"role":"assistant","content": completion.strip()}]}

# Ruta a la carpeta que contiene los archivos de código
input_folder = r"C:\Users\w10\Documents\NetBeansProjects\lenguaje-interpretado\ejemplos\training"
